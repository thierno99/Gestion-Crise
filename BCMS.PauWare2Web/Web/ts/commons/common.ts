 ...
 * @returns 
 */
export const CreatElt=(typeElt:string)=> {
 ...
 * @param label 
 */
export const addLabel=(elt:Element,label:string)=>{
 ...
 * @returns 
 */
export const creatInput=(type:string)=>{
 ...
 * @returns 
 */
export const createBtn=(label:string,textcontent:string,classe:string)=>{
 ...
 * @param contentValue 
 */
export const sendNbCar=(rescuer:Police|FireMan,content:Element,dest:Element,contentValue:string)=>{
  const div=CreatElt('div');
  ...
  btn.addEventListener('click',(e:Event)=>{
    rescuer.set_nbCarsToSend((div.children[1] as HTMLInputElement).valueAsNumber);
  })
 ...
 * @param dest 
 */
export const SelectRoadForPolice=(rescuer:Police,content:Element,dest:Element)=>{
  const btn=createBtn("Cliquez pour Choisir Une route pour les véhicules de Police","Choisir Une route","sr")
  dest.addEventListener('click',(e:Event)=>{
    content.innerHTML="";
 ...
 * @param contentv 
 */
export const SelectRoadForFireMans=(rescuer:Police,fireman:FireMan,content:Element,dest:Element,contentv:string)=>{
 ...
 * @param dest 
 */
export const DispatchCars=(rescuer:Police|FireMan,content:Element,dest:Element)=>{
 ...
 * @param contentv 
 */
export const DesagressWithPoliceRender=(rescuer:Police,fireman:FireMan,content:Element,dest:Element,contentv:string)=>{
 ...
 * @returns 
 */
export const CreatItag=(str:string)=>{
  const i=CreatElt('i');
    i.classList.add('fas');
    i.classList.add(str);
  return i;
}
export const RenderActions=(police:Police,fireman:FireMan,action:Element,content:Element,contentValue:any,btnname:string)=>{
    ...
    if(btnname==="fm") action.appendChild(li_);
    action.appendChild(li3);
    if(contentValue.value==="Police" && !police.get_isRoadValide()) action.appendChild(li3);
    ...
    export const HandleContent=(police:Police,fireman:FireMan, title:Element,content:Element, contentValue:any)=>{
      ...
      div5.addEventListener('click',(e:Event)=>{
        e.preventDefault();
        const nbvehicul=(div1.children[1] as HTMLInputElement).valueAsNumber;
      ...
      div2.addEventListener('click',(e:Event)=>{
        e.preventDefault();
        ...
        if(fireman.get_islog() && contentValue.value==="Police"|| (fireman.get_islog() && contentValue.value!=="Police") ){
          ...
          formcontent.appendChild(div4);
          if(formcontent.contains(div_)) formcontent.removeChild(div_);
        }
        
      })
    
      
      div3.addEventListener('click',(e:Event)=>{
        e.preventDefault();
      ...
      div_.addEventListener('click',()=>{
        ...
        formcontent.appendChild(div4);
        if(formcontent.contains(div3)) formcontent.removeChild(div3);
        fireman.set_isRoadValide(true);
