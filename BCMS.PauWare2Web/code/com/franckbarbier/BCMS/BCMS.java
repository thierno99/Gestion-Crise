...
// Error:
    ...
    public static void main(String args[]) {
        ...
        org.glassfish.tyrus.server.Server server = new org.glassfish.tyrus.server.Server("localhost", 1963, "/FranckBarbier", user_properties /* or 'null' */, com.franckbarbier.BCMS.Server.My_ServerEndpoint.class);
        ...
        try {
            ...
            Client client = new Client(java.util.Optional.of(Client.class.getSimpleName()));
...
//            reader.readLine();
        ...
        try {
            BCMS bCMS = new BCMS();
            java.util.HashMap<String, String> Request=com.franckbarbier.BCMS.Server.My_ServerEndpoint.msg;
...
//            Thread.sleep(10);
//            for (String s : bCMS.get_firtye_trucks(Status.Arrived)) {
//                System.out.println(Status.Arrived + ": " + s);
//            }
